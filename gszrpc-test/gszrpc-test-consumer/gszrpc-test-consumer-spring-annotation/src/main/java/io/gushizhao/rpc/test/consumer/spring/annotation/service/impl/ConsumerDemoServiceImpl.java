package io.gushizhao.rpc.test.consumer.spring.annotation.service.impl;
...
public class ConsumerDemoServiceImpl implements ConsumerDemoService {
    ...
    @RpcReference(registryType = "zookeeper", registryAddress = "127.0.0.1:2181", loadBalanceType = "zkconsistenthash",
            version = "1.0.0", group = "gushizhao", serializationType = "protostuff", proxy = "cglib", timeout = 30000,
            async = false, onwway = false)
