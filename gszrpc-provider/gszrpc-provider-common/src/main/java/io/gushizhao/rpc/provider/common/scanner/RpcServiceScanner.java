package io.gushizhao.rpc.provider.common.scanner;
            ...
            try {
                ...
                if (rpcService != null) {
                   ...
                   /* String serviceName = getServiceName(rpcService);
                    ...
                    ServiceMeta serviceMeta = new ServiceMeta(getServiceName(rpcService), rpcService.version(), host, port, rpcService.group(), getWeight(rpcService.weight()));
                    // 将元数据注册到注册中心
